...
const Renderer = {
    ...
    order() {
        ...
        document.querySelector('#supplier_search').value =
            State.order.supplier_name ?? '';

        document.querySelector('#supplier_id').value =
            State.order.supplier_id ?? '';
    ...
    summary() {
        ...
        document.querySelector('#total_amount').textContent =
            State.order.total_amount.toLocaleString();

        document.querySelector('#debt_amount_display').textContent =
            State.order.debt_amount.toLocaleString();

        document.querySelector('#total_amount_with_vat').textContent =
            State.order.total_amount_with_vat.toLocaleString();
