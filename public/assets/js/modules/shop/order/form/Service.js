...
const Service = {
    ...
    async searchCustomers() {
        ...
        const response =
            await Api.searchCustomers(keyword);
    ...
    async searchProducts() {
        ...
        const response =
            await Api.searchProducts(keyword);
    ...
    setDiscountAmount(index, value) {
        ...
        State.order.items[index].discount_amount =
            Number(value || 0);
    ...
    setGift(index, checked) {
        ...
        State.order.items[index].is_gift =
            checked;
    ...
    setSellingPrice(index, value) {
        ...
        State.order.items[index].selling_price =
            Number(value || 0);
