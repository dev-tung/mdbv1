...
!(function (t, e) {
    ...
    const t = new Map(),
        ...
        i = 'transitionend',
        n = (t) => (
            t && window.CSS && window.CSS.escape && (t = t.replace(/#([^\s"#']+)/g, (t, e) => `#${CSS.escape(e)}`)),
            t
        ),
        s = (t) =>
            null == t
              ...
              : ii(
                    (function (t) {
                        var e,
                            ...
                            l = -n.scrollTop;
                        return (
                            'rtl' === Se(s || i).direction && (a += Ae(i.clientWidth, s ? s.clientWidth : 0) - o),
    ...
    class Qi extends B {
        constructor(t, e) {
            (super(t, e),
                ...
                (this._menu =
                    R.next(this._element, Fi)[0] || R.prev(this._element, Fi)[0] || R.findOne(Fi, this._parent)),
        ...
        _selectMenuItem({ key: t, target: e }) {
            const i = R.find('.dropdown-menu .dropdown-item:not(.disabled):not(:disabled)', this._menu).filter((t) =>
                l(t),
            );
        ...
        static dataApiKeydownHandler(t) {
            ...
            const s = this.matches(ji)
                    ? this
                    : R.prev(this, ji)[0] || R.next(this, ji)[0] || R.findOne(ji, t.delegateTarget.parentNode),
        ...
        _setListeners() {
            ...
            for (const e of t)
                if ('click' === e)
                    ...
                    const t =
                            e === ls ? this.constructor.eventName('mouseenter') : this.constructor.eventName('focusin'),
                        i =
                            e === ls
