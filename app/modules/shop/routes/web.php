...
Router::get('/admin/categories', 'CategoryController@index', ['auth' => 'admin']);
...
Router::get('/admin/inventory', 'InventoryController@index', ['auth' => 'admin']);
...
Router::get('/admin/suppliers', 'SupplierController@index', ['auth' => 'admin']);
