...
Router::post('/api/products/update/{id}', 'ProductEndpoint@apiUpdate', ['auth' => 'admin']);
Router::post('/api/products/delete/{id}', 'ProductEndpoint@apiDelete', ['auth' => 'admin']);
...
Router::post('/api/categories/update/{id}', 'CategoryEndpoint@apiUpdate', ['auth' => 'admin']);
Router::post('/api/categories/delete/{id}', 'CategoryEndpoint@apiDelete', ['auth' => 'admin']);
...
Router::post('/api/brands/update/{id}', 'BrandEndpoint@apiUpdate', ['auth' => 'admin']);
Router::post('/api/brands/delete/{id}', 'BrandEndpoint@apiDelete', ['auth' => 'admin']);
...
Router::post('/api/inventories/update/{id}', 'InventoryEndpoint@apiUpdate', ['auth' => 'admin']);
Router::post('/api/inventories/delete/{id}', 'InventoryEndpoint@apiDelete', ['auth' => 'admin']);
...
Router::post('/api/suppliers/update/{id}', 'SupplierEndpoint@apiUpdate', ['auth' => 'admin']);
Router::post('/api/suppliers/delete/{id}', 'SupplierEndpoint@apiDelete', ['auth' => 'admin']);
...
Router::post('/api/warehouses/update/{id}', 'WarehouseEndpoint@apiUpdate', ['auth' => 'admin']);
Router::post('/api/warehouses/delete/{id}', 'WarehouseEndpoint@apiDelete', ['auth' => 'admin']);
...
Router::post('/api/purchases/update/{id}', 'PurchaseEndpoint@apiUpdate', ['auth' => 'admin']);
Router::post('/api/purchases/delete/{id}', 'PurchaseEndpoint@apiDelete', ['auth' => 'admin']);
...
Router::post('/api/orders/update/{id}', 'OrderEndpoint@apiUpdate', ['auth' => 'admin']);
Router::post('/api/orders/delete/{id}', 'OrderEndpoint@apiDelete', ['auth' => 'admin']);
